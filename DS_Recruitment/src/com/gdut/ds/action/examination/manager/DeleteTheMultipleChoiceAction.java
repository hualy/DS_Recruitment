...
public class DeleteTheMultipleChoiceAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		multipleChoice.setId(Integer.parseInt(mid));
		...
		examinationService.deleteMultipleChoice(multipleChoice);
