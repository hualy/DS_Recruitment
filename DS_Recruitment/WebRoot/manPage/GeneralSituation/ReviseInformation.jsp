...
<html>
  <head>
	...
	<script type="text/javascript" src="js/manJs/GeneralSituaionJs/ReviseInformationJs.js"></script>
      ...
      <div class="content">
        ...
        <div class="mainContent">
			<div class="container">
	            ...
	            %>
	            <div class="exist-info container">
	              <table class="table table-striped">
	                <tr  id="trRevise" class="info"><td>主题</td><td>发布人</td><td>时间</td><td>操作</td></tr>
	                <!-- 
	                <%for(int i=0;i<8;i++){ %>
	                <tr><td>xxxx</td><td>xxx</td><td>2016-03-08</td>
	                  <td>
	                    <button class="btn btn-default rev-btn" type="button">修改</button>
	            ...
	            <form class="form-horizontal" action="admin/introduction/updateArticle" enctype="multipart/form-data" method="post" id="rev-info-form">
		            ...
		            <div class="form-group has-feedback speakerBar">
			 		...
			 		<div class="form-group">
		                <label for="time" class="col-sm-2 control-label">推送内容：</label>
		                <div class="col-sm-8">
		                    <textarea name="content" >请输入推送内容</textarea>
		                </div>
		             </div> 
		            <button class="btn btn-success col-sm-2 col-sm-offset-2" type="button" id="save-btn">保存修改</button>
		            
		            <button class="btn btn-danger col-sm-2 col-sm-offset-2 cancel-btn" type="button" onclick='deleteTempImage()'>放弃修改</button>
		            <input type="hidden" name="articleId"></input>    
	            </form>  
			</div>
        </div>
      </div>
